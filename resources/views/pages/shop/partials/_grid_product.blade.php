<div
  ...
  <a target="_blank"
    ...
    href="{{ config('features.obfuscate_link_to_pdp') ? '#' : route('get.products.product', ['product' => $product['slug']]) }}"
  ...
  <a target="_blank"
    ...
    @if($brand_slug = \Slugify::slugify($product['brand_original']))
      <span class="product-thumb-brand" itemprop="brand" itemscope itemtype="https://schema.org/Brand">
        <meta itemprop="url" content="{{ route('get.products.byBrand', ['brand' => $brand_slug]) }}" />
