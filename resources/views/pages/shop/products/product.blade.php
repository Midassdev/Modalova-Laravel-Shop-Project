...
@if(config('features.add_noindex_to_product_pages'))
  @section('robots')<meta name="robots" content="NOINDEX,FOLLOW">@stop
@endif
        ...
        <div class="section-bg-color">
          ...
          <div class="infos-group">
            <div class="primary-infos">
              ...
              @if($brand_slug = \Slugify::slugify($data['product']['brand_original']))
                <div itemprop="brand" itemscope itemtype="https://schema.org/Brand">
                  <a
                    href="{{ route('get.products.byBrand', ['brand' => $brand_slug]) }}"
                    target="_blank"
                    itemprop="url"
