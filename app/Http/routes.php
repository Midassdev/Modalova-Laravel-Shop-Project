...
Route::group([
    ...
    Route::get(_i('produit').'/{product}.json', 'ApiController@products');
    ...
    Route::get(_i('faq'), function() {
        return redirect()->route('get.static.faq', null, 301);
    });
    Route::get(_i('mentions-legales'), function() {
        return redirect()->route('get.static.legals', null, 301);
    });
    Route::get(_i('a-propos'), function() {
        return redirect()->route('get.static.about', null, 301);
    });
    ...
    Route::get('faq',    'StaticsController@getFAQ')->name('get.static.faq');
    Route::get('legals', 'StaticsController@getLegals')->name('get.static.legals');
    Route::get('about',  'StaticsController@getAbout')->name('get.static.about');
});
...
Route::group([
    ...
    Route::get('/brands/{brand}', 'ApiController@brands')->name('api.brands');
...
Route::group([
    ...
    Route::get(PREFIX_COLOR.'-{color}', 'ProductsController@getGrid')
        ->name('get.products.byColor');

    Route::get('{gender}/'.PREFIX_COLOR.'-{color}', 'ProductsController@getGrid')
        ->name('get.products.byGender.byColor');
