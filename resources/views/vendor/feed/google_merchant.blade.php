    ...
    <channel>
        ...
        @foreach($items as $item)
            <item>
                ...
                <g:image_link>{{ url(\App\Libraries\Cloudinary::get($item->image, '', $item->slug)) }}</g:image_link>
                <g:condition><![CDATA[new]]></g:condition>
                <g:availability><![CDATA[in stock]]></g:availability>
                <g:price>{{ $item->price . ' ' . $item->currency }}</g:price>
                <g:brand><![CDATA[{{ $item->brand }}]]></g:brand>
                <g:gender><![CDATA[{{ \App\Models\Gender::getNormalizedValue($item->gender) }}]]></g:gender>
