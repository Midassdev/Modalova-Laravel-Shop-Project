  ...
  <div class="container brands-top brand-container">
    <div class="col-md-8 col-md-offset-2">
      ...
      @if(empty($data['brand_type']))
        <center>
          @foreach(App\Models\BrandType::ordered()->get() as $brand_type)
            <a href="{{ route('get.brands.index_for_type', [ 'brand_type' => $brand_type, ]) }}" class="btn btn-black">{{ _i("Marques %s", $brand_type->name) }}</a>
          @endforeach
        </center>
      @endif
