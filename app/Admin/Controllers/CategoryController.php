...
class CategoryController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        $grid->column('allow_indexing_of_paginated_pages')->sortable()->switch();
    ...
    protected function detail($id)
    {
        ...
        $show->field('allow_indexing_of_paginated_pages');
    ...
    protected function form()
    {
        ...
        $form->switch('allow_indexing_of_paginated_pages');
