...
class WhiteList extends BaseModel
{
	...
	const MINIMUM_REQUIRED_PRODUCTS = 10;
	...
	const REASON_CATEGORY_ALLOWS_INDEXING = 'Category allowed indexing of paginated pages';
	...
	{
		$gender = (Gender::GENDER_BOTH == $this->gender) ? '' : ucfirst(_i($this->gender));
