...
class DaisyconTest extends BaseParser
{
    ...
    public function test__parse_row__from_Kings_of_Indigo_femme()
    {
        ...
        $expected_value = [
            ...
            'category_original' => 'jumpsuit|vrouwen|kleding',
    ...
    public function test__parse_row__from_Cupshe_femme_discount()
    {
        ...
        $expected_value = [
            ...
            'currency_original' => 'EUR',
            'category_original' => 'vêtements et accessoires|vêtements|vêtements de bain|bikini',
